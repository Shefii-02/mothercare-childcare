                ...
                <div class="hhc-title-bar-content-inner">
                    <div class="hhc-tbar">
                        <div class="hhc-tbar-inner container">
                            <h1 class="hhc-tbar-title"> {{ $package->name }}</h1>
                        </div>
                    </div>
                    <div class="hhc-breadcrumb">
                        <div class="hhc-breadcrumb-inner">
                            ...
                            >
                            <span>
                                <a href="{{ route('public.packages') }}" class="home">
                                    <span>Services</span>
                                </a>
                            </span>
                            >
                        ...
                        <div class="col-lg-12">
                            <aside class="aside-services">
                                <div class="card rounded-5 border-0 shadow-lg our-services">
                                    <h2 class="text-theme fs-4 px-3 pt-4 pb-3 fw-bold"><i class="bi bi-activity text-theme"></i> Our Services</h2>

                                    <ul class="px-3">
                                        @foreach ($packages as $packageItem)
                                            <li>
                                                <a href="{{ route('public.packages-single',$packageItem->slug) }}">
                                                    {{ $packageItem->name }}
                                                </a>
                                            </li>
                                        @endforeach
