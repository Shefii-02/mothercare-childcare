                ...
                <div class="col-12 header-first-col shadow" style="position: relative;">
                    <div class="first-li-div position-relative">
                        <ul class="first-ul d-flex justify-between">
                            <li>
                                <a class="mobile-menu" data-bs-toggle="offcanvas" href="#offcanvasExample"
                                ...
                                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
                                    ...
                                    <div class="offcanvas-header">
                                        ...
                                        <a href="https://www.mysweetiepie.ca/sign-in"
                                        ...
                                        <div class="for-sup">
                                                ...
                                                <ul id="header-wr" class="menu">
                                                    ...
                                                    <li class="menu-item-has-children">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="https://www.mysweetiepie.ca">Home</a>
                                                    ...
                                                    <li class="nav-item dropdown">
                                                        ...
                                                        <a class="nav-link dropdown-toggle" href="#"
                                                            ...
                                                            data-bs-toggle="dropdown" aria-expanded="false">Pies</a>
                                            ...
                                            <div class="icons-for-carts d-sm-block d-md-none">
                                                ...
                                                <span><a class="text-light"
                                                        href="https://www.mysweetiepie.ca/sign-in"><i
                                        ...
                                        <div class="social-links">
                                            <ul>
                                                <li class="text-capitalize">
                                                    <a href="https://www.facebook.com/mysweetiepie.ca"
                    ...
                    <div class="px-4">
                        <ul class="d-flex gap-3 align-items-end align-content-end m-1">
                            ...
                            <li class="last-one">
                                <a class="" id="" data-bs-toggle="" href="">
...
<!-- Mirrored from htmldemo.net/juan/juan/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 07:16:06 GMT -->
